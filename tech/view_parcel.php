...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-primary">Mobile Information</b>
					<dl>
						<dt>Name:</dt>
			...
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-primary">Assories Details</b>
						<div class="row">
						<div class="col-sm-6">
								<dl>
									<dt>Sim</dt>
...
<div class="modal-footer display p-0 m-0">
		...
		<form action="print.php?variable_name=<?php echo $reference_number;?>" method="POST"> 
    <button>
        <input  type="hidden" name="x">Print
